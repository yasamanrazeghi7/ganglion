...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { description: @experiment.description, is_active: @experiment.is_active, researcher: @experiment.researcher, title: @experiment.title }
    end
  ...
  test "should update experiment" do
    patch :update, id: @experiment, experiment: { description: @experiment.description, is_active: @experiment.is_active, researcher: @experiment.researcher, title: @experiment.title }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
